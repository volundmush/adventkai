...
import adventkai
from adventkai.utils import import_from_module, callables_from_module
...
class Core:
    ...
    def copyover(self):
        data_dict = dict()
        for k, v in adventkai.SERVICES.items():
            v.do_copyover(data_dict)

        for func in adventkai.HOOKS["copyover"]:
            func(data_dict)
